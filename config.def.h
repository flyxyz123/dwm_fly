...
static Key keys[] = {
	...
	{ 0, XF86XK_MonBrightnessUp, spawn, SHCMD("echo $(($(cat /sys/class/backlight/intel_backlight/brightness)+$(cat /sys/class/backlight/intel_backlight/max_brightness)/20)) | sudo tee /sys/class/backlight/intel_backlight/brightness > /dev/null") },
	{ 0, XF86XK_MonBrightnessDown, spawn, SHCMD("echo $(($(cat /sys/class/backlight/intel_backlight/brightness)-$(cat /sys/class/backlight/intel_backlight/max_brightness)/20)) | sudo tee /sys/class/backlight/intel_backlight/brightness > /dev/null") },
